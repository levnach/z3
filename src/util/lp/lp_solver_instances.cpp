...
template void lp::lp_solver<double, double>::fill_column_names_for_core_solver();
...
template void lp::lp_solver<double, double>::print_statistics_on_A();
...
template void lp::lp_solver<lp::mpq, lp::mpq>::fill_column_names_for_core_solver();
...
template void lp::lp_solver<lp::mpq, lp::mpq>::print_statistics_on_A();
