...
#endif
template void lp::square_dense_submatrix<double, double>::apply_from_right(std::vector<double, std::allocator<double> >&);
...
template void  lp::square_dense_submatrix<double, double>::apply_from_left_to_vector<double>(std::vector<double, std::allocator<double> >&);
