...
template void lean::permutation_matrix<double, double>::apply_reverse_from_left_to_T(std::vector<double, std::allocator<double> >&);
template void lean::permutation_matrix<double, double>::apply_reverse_from_right_to_T(std::vector<double, std::allocator<double> >&);
...
template void lean::permutation_matrix<lean::mpq, lean::mpq>::apply_reverse_from_left_to_T(std::vector<lean::mpq, std::allocator<lean::mpq> >&);
template void lean::permutation_matrix<lean::mpq, lean::mpq>::apply_reverse_from_right_to_T(std::vector<lean::mpq, std::allocator<lean::mpq> >&);
...
template void lean::permutation_matrix<lean::mpq, lean::numeric_pair<lean::mpq> >::apply_reverse_from_left_to_T(std::vector<lean::mpq, std::allocator<lean::mpq> >&);
template void lean::permutation_matrix<lean::mpq, lean::numeric_pair<lean::mpq> >::apply_reverse_from_right_to_T(std::vector<lean::mpq, std::allocator<lean::mpq> >&);
